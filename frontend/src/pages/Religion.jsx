...
const filas = [
  ...
  },
  {
    titulo: "Hathor",
    parrafo:
      "Era considerada una deidad multifacética asociada con el amor, la maternidad, la música, la danza, la belleza, la alegría y la protección. Hathor era representada como una mujer con cabeza de vaca o con una corona solar que llevaba el disco solar y dos cuernos de vaca. La cabeza de vaca era un símbolo de maternidad y fertilidad, y Hathor era considerada la madre de todos los seres vivos. Su apariencia también podía variar, ya que en algunas representaciones se la mostraba con rasgos completamente humanos.",
    imagen: Hathor,
    lado: "izq",
  },
  {
    ...
    <Box sx={{ py: 8 }}>
      <Box sx={{ px: "15%", py: 4 }}>
        ...
        <Typography variant="body1" sx={{ textAlign: "justify" }}>
          La religión en el antiguo Egipto era una parte fundamental de la vida
          cotidiana y la cultura egipcia. Los antiguos egipcios tenían una
          creencia en una amplia variedad de dioses y diosas que gobernaban
          diferentes aspectos del mundo y de la vida humana. La religión
          desempeñaba un papel importante en la sociedad, la política y la vida
          después de la muerte. Los egipcios creían en la existencia de dioses y
          diosas que eran representados con características humanas o animales.
          Cada deidad tenía sus propias responsabilidades y dominios, y se les
          adoraba y honraba a través de rituales y ceremonias.
        </Typography>
        <Typography variant="body1" sx={{ textAlign: "justify" }}>
          Algunos de los dioses más importantes incluían a Ra, el dios del sol;
          Osiris, el dios de la vida después de la muerte e Isis, la diosa de la
          maternidad y la magia.
        </Typography>
      </Box>
      ...
      <Box sx={{ px: "15%", py: 4 }}>
        <Typography>
          La religión en el antiguo Egipto también se centraba en la vida
          después de la muerte. Los egipcios creían en la existencia de una vida
          después de la muerte y se esforzaban por asegurarse una vida eterna.
          Para lograr esto, se llevaban a cabo rituales de embalsamamiento y se
          construían tumbas y monumentos funerarios, como las pirámides, para
          proteger los cuerpos y las almas de los difuntos. El Libro de los
          Muertos era una colección de hechizos y oraciones que se colocaban en
          las tumbas para guiar y proteger al difunto en su viaje al más allá.
        </Typography>
        <Button
