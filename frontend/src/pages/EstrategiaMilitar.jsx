...
const filas = [
  ...
  },
  {
    ...
    parrafo: "La estrategia defensiva desempeñaba un papel importante en el Antiguo Egipto. Para proteger su territorio, los egipcios construían fortificaciones y ciudades amuralladas. Estas estructuras defensivas eran diseñadas para resistir los ataques enemigos y proporcionar puntos de observación estratégicos. La ubicación geográfica también era considerada, utilizando ríos y pantanos como barreras naturales.",
    imagen: Murallas,
    lado: "der",
  },
   {
    titulo: "La flota naval",
    parrafo: "El Antiguo Egipto también tenía una flota naval para proteger sus costas y controlar el comercio marítimo. Las embarcaciones egipcias estaban equipadas con remos y velas, y se utilizaban para el transporte de tropas y suministros, así como para el combate naval. La flota naval egipcia jugó un papel clave en la expansión y defensa del imperio.",
    imagen: Barco,
    lado: "izq",
  },
  {
    titulo: "La diplomacia y la guerra como último recurso",
    parrafo: "Aunque los egipcios eran hábiles en la guerra, preferían la diplomacia y el establecimiento de alianzas como medio para resolver conflictos. La guerra se consideraba el último recurso y se buscaban soluciones pacíficas cuando era posible.",
    imagen: Diplomacia,
    lado: "der",
  },
  ...
  return (
    <Box sx={{ py: 8 }}>
      ...
      <Typography variant="h2" textAlign="center" sx={{ mb: 6 }}>
        ...
        Aunque los egipcios eran hábiles en la guerra, preferían la diplomacia y 
        el establecimiento de alianzas como medio para resolver conflictos. 
      ...
      <Box sx={{ px: "15%", py: 4 }}>
        <Typography>
        la estrategia militar del Antiguo Egipto fue un componente vital para la protección, 
        expansión y supervivencia del imperio. A través de una organización militar bien estructurada, 
        el uso efectivo de armas como carros de guerra, infantería, arqueros y una planificación defensiva sólida, 
        los egipcios lograron mantener el control sobre su territorio y enfrentarse a las amenazas externas. 
        Además, su enfoque en la diplomacia y la resolución pacífica de conflictos demostró su sabiduría estratégica, 
        la cual egipcia fue una combinación de fuerza, inteligencia y adaptabilidad, 
        su legado continúa siendo un testimonio de la grandeza y la habilidad militar de esta antigua civilización.
        </Typography>
        <Button
